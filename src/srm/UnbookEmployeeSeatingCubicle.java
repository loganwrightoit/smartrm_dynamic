...
@WebServlet("/UnbookEmployeeSeatingCubicle")
public class UnbookEmployeeSeatingCubicle extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public UnbookEmployeeSeatingCubicle() {
        super();
        // TODO Auto-generated constructor stub
    }

	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		request.getRequestDispatcher("/WEB-INF/views/esc_booking_remove.jsp").forward(request, response);
	}
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		try
		{
			...
			boolean works=d.unbookEmployeeSeatingCubible(bId, rName);
		}
