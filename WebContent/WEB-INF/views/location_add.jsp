	...
	<jsp:body>
		...
		<div class="floating-box round-corners">
			...
			<form action="InsertLocation" method="Post">
				...
				<h3 class="title">Create a New Location</h3>
		        ...
		        <div class="form-group">
					...
					<br>
		            <textarea name="l_desc" class="form-control" placeholder="Enter Description"></textarea>
		        </div>
	
		        <div class="form-group">
					<label>Phone</label>
					<br>
		            <input type="tel" name="l_phone" class="form-control" placeholder="Enter Phone Number" required/>
		        </div>
	
		        <div class="form-group">
					<label>Location Head</label>
					<br>
		            <input type="text" name="l_head" class="form-control" placeholder="Enter Location Head" required/>
		        </div>
	
		        <div class="form-group">
					<label>City</label>
					<br>
		            <input type="text" name="l_city" class="form-control" placeholder="Enter City" required/>
		        </div>
	
		        <div class="form-group">
					<label>Country</label>
					<br>
		            <input type="text" name="l_country" class="form-control" placeholder="Enter Country" required/>
		        </div>
